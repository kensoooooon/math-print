...
class SectorWithFigureProblem:
    ...
    def __init__(self, **settings):
        ...
        self.latex_answer, self.latex_problem, self.sector = self._make_problem()
    ...
    def _make_problem(self):
        ...
        if selected_problem_type == "radius_and_central_angle_to_arc_length_and_area":
            latex_answer, latex_problem, sector = self._make_radius_and_central_angle_to_arc_length_and_area_problem()
        elif selected_problem_type == "radius_and_arc_length_to_area":
            latex_answer, latex_problem, sector = self._make_radius_and_arc_length_to_area_problem()
        elif selected_problem_type == "radius_and_area_to_arc_length":
            latex_answer, latex_problem, sector = self._make_radius_and_area_to_arc_length_problem()
        elif selected_problem_type == "radius_and_area_to_central_angle":
            latex_answer, latex_problem, sector = self._make_radius_and_area_to_central_angle_problem()

        return latex_answer, latex_problem, sector
